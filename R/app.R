 ...
 # logo image
  ...
  output$info <- renderUI({
    tagList(
            ...
            div(HTML("<b>Official Website and Usage Notes</b>:"), a("https://www.clcestimator.com/", href ="https://www.clcestimator.com/")),
            div(style = "padding: 5px 5px"),
            div(HTML("<b>Video Tutorial</b>:"), a("https://www.youtube.com/watch?v=P57WU1o5KsM", href ="https://www.youtube.com/watch?v=P57WU1o5KsM")),
            div(style = "padding: 5px 5px"),
            div(HTML("<b>To cite the CLC Estimator (APA 7th)</b>: Marzi, G., Balzano, M., Egidi, L., Magrini, A. (2023). CLC estimator: a tool for latent construct estimation via congeneric approaches in survey research. <em>Multivariate Behavioral Research</em>, (in press). DOI:"), a("https://doi.org/10.1080/00273171.2023.2193718", href = "https://doi.org/10.1080/00273171.2023.2193718")),
            div(style = "padding: 5px 5px"),
            div(HTML("<b>Source code</b>:"), a("https://github.com/LeoEgidi/clc", href= "https://github.com/LeoEgidi/clc")),
            div(style = "padding: 5px 5px"),
